<%@ Page Title="HR Portal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaintainEmployee.aspx.cs" Inherits="HR_Portal.MaintainEmployee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <input id="Emp_Num" type="text" name="empnum" class="form-control max-wide" onkeypress="InputNumber(event)">
                                            </div>
                                        </div>
                                    </div>
                                    <!--- End EmpCode --->
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <input id="Emp_Email" type="text" class="form-control max-wide" disabled>
                                        </div>
                                    </div>
                                </div>
                                <!--- End Email --->
                                ...
                                <div class="col-md-4 col-sm-3 col-xs-12">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-5 col-xs-12">
                                            <input id="Emp_Extension" type="text" class="form-control max-wide" disabled>
                                        </div>
                                    </div>
                                </div>
                                <!--- End Extension --->
    ...
    <div class="panel nav-tab panel-default">
        <div class="panel-heading">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item ">
                    <a href="#Benefits" class="nav-link " role="tab" data-toggle="tab">Benefits</a>
                </li>
                <li class="nav-item disabled">
            ...
            <div class="panel-body">
                <div class="tab-content">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="row form-group">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="Emp_StartLongevity" type="number" class="form-control max-wide">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                ...
                                <table id="TB_Certificate" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Description</th>
                                            <th style="width: 40px">Certificate</th>
                                            <th style="width: 20px"></th>
                                        </tr>
                                    </thead>
                                    <tbody id="ListCer">
                                        <%--<tr>
                                            <td><input type="text" class="form-control max-wide" id="CerDesc"></td>
                                            <td><button type="button" class="btn btn-info" id="btnAddCer">Add Row</button></td>
                                        </tr>--%>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="modal fade" id="modalSiteRef" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="col-md-12 col-lg-12 col-sm-12" style="margin-bottom: 1em;">
                                        <h4 class="modal-title">Site Refernce</h4>
                                    </div>
                                </div>
                                <div class="modal-body" style="overflow-y: auto; max-height: 28em; max-width: 100%;">
                                    <select class="form-control" id="siteRefDorpdown">
                                        <option value="">--------------Select Site--------------</option>
                                    </select>

                                </div>
                                <div class="modal-footer">
                                    <button id="btnsync" class="btn btn-danger" type="button">Sync</button>
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <%--End attach --%>
                    <%--modal img edu  --%>
                    <div class="modal fade" id="modalImgEdu" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="col-md-12 col-lg-12 col-sm-12" style="margin-bottom: 1em;">
                                        <div class="col-md-9 col-lg-9 col-sm-12">
                                            <h4 class="modal-title">Education Image</h4>
                                        </div>
                                        <div class="col-md-3 col-lg-3 col-sm-12" style="text-align: right;">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                        </div>
                                ...
                                <div class="modal-body" style="overflow-y: auto; max-height: 28em; max-width: 100%;">
                                    <img class="thumbnail img-preview" style="width: 60%; max-width: 100%; height: 100%;" src="images/img.png" alt="edu_img" id="img_edu" />
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            sessionStorage.setItem('Page_type', 'Master');
          ...
          <%--  $.ajax({
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "<%= ResolveUrl("MaintainEmployee.aspx/GetMA_K2")%>",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: GetMA_K2
            });
            ...
            if (getemp != "") {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee.aspx/GetListEducation")%>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ search: $("#Emp_Num").val() }),
                    success: getlistEdu
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee.aspx/GetCertificate")%>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ search: $("#Emp_Num").val() }),
            ...
            $("#btnsave").on('click', function () {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee.aspx/SP_HR_Employee") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        Emp_Num: Emp_Num,
            ...
            $("#btnupdate").on('click', function () {
                ...
                var Emp_HireDate = $("#Emp_HireDate").val() == null ? '' : $("#Emp_HireDate").val();
                var Emp_HR_Shift_ID = $("#Emp_HR_Shift_ID").val();
                var Emp_Type = $("#Emp_Type").val() == null ? '' : $("#Emp_Type").val();
                var Emp_ID_Card = $("#Emp_ID_Card").val();
                var Emp_ID_Card_Expired_Date = $("#Emp_ID_Card_Expired_Date").val();
                var Emp_Birth_Date = $("#Emp_Birth_Date").val();
                var Emp_Gender = $("#Emp_Gender").val();
            ...
            $("#btnsync").on('click', function () {
                if ($("#siteRefDorpdown").val() == '') {
                    alert('Please Select the Site Reference.');
                } else {
                    var Emp_Num = $("#Emp_Num").val();
                    var Main_Company = $("#siteRefDorpdown").val();
                    $.ajax({
                        type: "post",
                        async: false,
                        url: "<%= ResolveUrl("MaintainEmployee.aspx/btnsync_Click") %>",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify({
                            Empnum: Emp_Num,
                            MainComp: Main_Company
                        }),
                        success: function (response) {
                            alert(response.d);
                            console.log(response.d);
            ...
            $(document).on("click", "#btnAddEdu", function () {
                ...
                //var image = $("#EmpImg")[0].files[0];
                //var imgName = $("#ImgName").val();
                //var Emp_image = "\\\\portalapp01\\ImageHRDatabase\\" + imgName +"." + (($('#EmpImg').val()).replace(/^.*\./, '')).toLowerCase();
                $("#ListEdu").empty();
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee.aspx/SP_HR_Employee_Education") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        ID: 0,
            ...
            <%--$(document).on("click",".btnupdateEdu", function () {
                ...
                var Emp_Num = $('#Emp_Num').val();
                var Level = tr.find("td:nth-child(1)").parent().find("input[name=Edulevel]").val();
                var Institution = tr.find("td:nth-child(2)").parent().find("input[name=EduInsi]").val();
                var Faculty = tr.find("td:nth-child(3)").parent().find("input[name=EduFacu]").val();
                var Major = tr.find("td:nth-child(4)").parent().find("input[name=EduMajor]").val();
                var Graduate = tr.find("td:nth-child(5)").parent().find("input[name=EduGraduate]").val();
                var image = tr.find("td:nth-child(6)").parent().find("input[name=EmpImg]")[0].files[0];
                var Emp_image = "\\\\PORTALAPP01\\ImageHRDatabase\\" + Emp_Num +".jpg";
                $("#ListEdu").empty();
                $.ajax({
                    type: "post",
                    async: false,
            ...
            $(document).on('click', "#btnAddCer", function () {
                ...
                //var Emp_Certificate = "";
                //var txtCer = $("#txtCer").val();
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee.aspx/SP_HR_Employee_Certificate") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        ID: 0,
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset = utf-8",
                        dataType: "json",
                        data: JSON.stringify({ user: user, page: 'Employee' }),
                        success: function (response) {
                            if (response.d.length > 0 && response.d[0][4] == 'True') {
                                ...
                                $('#btnAddEdu').prop('disabled', false);
                                $('#btnAddCer').prop('disabled', false);
                            } else {
                                ...
                                $('#btnAddEdu').prop('disabled', true);
                                $('#btnAddCer').prop('disabled', true);
            ...
            $(document).on("click", ".clickselectGroupExport", function () {
                ...
                $("#Emp_GroupExport").val(costCenter);
            ...
            $(document).on('click', ".showAttach", function () {
                var img_src = 'http:' + $(this).attr("data-name");
                //$("#img_edu").attr('src', img_src);
                //$("#modalImgEdu").modal('show');
            ...
            $(document).on('click', ".attach", function () {
                ...
                //$("#img_edu").attr('src', img_src);
                $('#saveAttach').attr('data-id', ref_id);
                $('#saveAttach').attr('data-type', type);
                getAttachment(ref_id, type);
                $("#modalAttach").modal('show');
            });

            $(document).on('click', "#saveAttach", function () {
                var ref_id = $(this).attr('data-id');
                var type = $(this).attr('data-type');
                var Emp_Num = $("#Emp_Num").val();
                $("#ListAttach2 tr").each(function () {
                    var image = $(this).find("td:nth-child(1)").find("input[type=file]")[0].files[0];//$("#EmpImg")[0].files[0];
                    var imgName = $(this).find("td:nth-child(2)").find("input[type=text]").val();
                    var Emp_image = "\\\\portalapp01\\HRPoralFiles\\" + type + "\\" + Emp_Num + "\\" + imgName + "." + (($(this).find("td:nth-child(1)").find("input[type=file]").val()).replace(/^.*\./, '')).toLowerCase();

                    $.ajax({
                        type: "post",
                        async: false,
                        url: "<%= ResolveUrl("MaintainEmployee.aspx/SP_HR_Employee_Attachment") %>",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify({
                            ID: 0
                        ...
                        success: function (response) {
                            insertFile(image, "", imgName, type + "\\" + $("#Emp_Num").val());
                            getAttachment(ref_id, type);
                        }
                    });
        ...
        function getlistEdu(response) {
            ...
            if (response.d.length > 0) {
                $.each(response.d, function (index, val) {
                    ...
                    fragment += '<td><input type="text" name="Edulevel" class="form-control max-wide"  value="' + Level + '" disabled></td>';
                    fragment += '<td><input type="text" name="EduInsi" class="form-control max-wide"  value="' + Institution + '"disabled></td>';
                    fragment += '<td><input type="text" name="EduFacu" class="form-control max-wide"  value="' + Faculty + '"disabled></td>';
                    fragment += '<td><input type="text" name="EduMajor" class="form-control max-wide"  value="' + Major + '"disabled></td>';
                    fragment += '<td><input type="text" name="EduGraduate" class="form-control max-wide"  value="' + Graduate + '"disabled></td>';
                    //fragment += '<td><input type="file" name="EmpImg" class="form-control max-wide EmpImg" value="' + Image + '"></td>';
                    //fragment += '<td style="text-align: center"><button type="button" class="btn btn-success ImgName" data-name="'+Image+'">Show</button></td>';
                    //fragment += '<td><button class="btn btn-warning btnupdateEdu" type="button">Update</button></td>';
                    fragment += '<td><button type="button" class="btn btn-warning attach" data-id="' + id + '" data-type="Education">Attachment</button></td>';
                    fragment += '<td><button type="button" class="btn btn-danger btndeleteEdu">Delete</button></td>';
                    fragment += '</tr>';

                });
            } else { }
            $("#ListEdu").append(fragment);
            fragment2 += '<tr>';
            fragment2 += '<td><input type="text" id="Level" class="form-control max-wide"></td>';
            fragment2 += '<td><input type="text" id="Institution" class="form-control max-wide"></td>';
            fragment2 += '<td><input type="text" id="Faculty" class="form-control max-wide"></td>';
            fragment2 += '<td><input type="text" id="Major" class="form-control max-wide"></td>';
            fragment2 += '<td><input type="text" id="Graduate" class="form-control max-wide"></td>';
            //fragment2 += '<td><input type="file" id="EmpImg" class="form-control max-wide"></td>';
            //fragment2 += '<td><input type="text" id="ImgName" class="form-control max-wide"></td>';
            fragment2 += '<td><button type="button" class="btn btn-info" id="btnAddEdu">Add Row</button></td>';
            fragment2 += '</tr>';
            $("#ListEdu").append(fragment2);
        }

        function GetCertificate(response) {
            var fragment = '';
            var fragment2 = '';
            if (response.d.length > 0) {
                $.each(response.d, function (index, val) {
                    var ID = val[0];
                    var Emp_Certificate = val[2];
                    var Description = val[3];
                    fragment += '<tr data-id="' + ID + '">';
                    fragment += '<td>  <input type="text" class="form-control max-wide CerDesc" value="' + Description + '" disabled></td>';
                    fragment += '<td> <button type="button" class="btn btn-warning attach" data-type="Certificate" data-id="' + ID + '">Attachment</button> </td>';
                    fragment += '<td><button type="button" class="btn btn-danger btndeleteCer">Delete</button></td>';
                    fragment += '<tr/>';
                });
                $("#ListCer").append(fragment);
            }
            fragment2 += '<tr>';
            fragment2 += '<td><input type="text" class="form-control max-wide" id="CerDesc"></td>';
            fragment2 += '<td><button type="button" class="btn btn-info" id="btnAddCer">Add Row</button></td>';
            fragment2 += '</tr>';
            $("#ListCer").append(fragment2);
        }

        $(document).on("click", ".delAttachlist", function () {
            var r = confirm("Confirm Delete");
            if (r === true) {
                var tr = $(this).closest("tr");
        ...
        function getAttachment(ref_id, type) {
            $("#ListAttach").empty();
            $("#ListAttach2").empty();
            var fragment = '';
            var fragment2 = '';
            $.ajax({
                type: "post",
                async: false,
                url: "<%= ResolveUrl("MaintainEmployee.aspx/GetListAttachment")%>",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ ref_id: ref_id, type: type }),
                success: function (response) {
                    if (response.d.length > 0) {
                        $.each(response.d, function (index, val) {
                            var id = val[0];
                            ...
                            fragment += '<tr data-id="' + id + '" data-ref="' + ref_id + '" data-type="' + type + '">';
                            fragment += '<td><button type="button" class="btn btn-warning showAttach" data-name="' + part + '">Show</button></td>';
                            fragment += '<td><input type="text" class="form-control max-wide" value="' + name + '" disabled ></td>';
                            fragment += '<td><button type="button" class="btn btn-danger delAttachlist" >Delete</button></td>';
                            fragment += '</tr>';
                        });
                    } else { }
                    fragment2 += '<tr id="attachClone">';
                    fragment2 += '<td><input type="file" class="form-control max-wide EmpImg"></td>';
                    fragment2 += '<td><input type="text"  class="form-control max-wide ImgName" placeholder="File Name"></td>';
                    fragment2 += '<td><button type="button" class="btn btn-success" onclick="addAttach()" ><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button></td>';
                    fragment2 += '</tr>';
                    $("#ListAttach").append(fragment);
                    $("#ListAttach2").append(fragment2);
                }
            });
        }
        ...
        function addAttach() {
            ...
            fragment += '<td><input type="file"  class="form-control max-wide EmpImg"></td>';
            fragment += '<td><input type="text"  class="form-control max-wide ImgName" placeholder="File Name"></td>';
            fragment += '<td><button type="button" class="btn btn-danger" id="delAttach" onclick="deleteRow(this)"><i class="glyphicon glyphicon-trash" aria-hidden="true" style="color:white"></i></button></td>';
            fragment += '</tr>';
