<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaintainEmployee_Draft2.aspx.cs" Inherits="HR_Portal.MaintainEmployee_Darft" %>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-9 col-sm-6 col-xs-12">
                                                ...
                                                <label class="radio-inline">
                                                    <input name="Prefix" id="Other" value="อื่นๆ" type="radio" /><span id="P4">อื่นๆ</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                <div class="tab-content">
                            ...
                            <div class="row form-group">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 date" data-provide="datepicker">
                                        <input placeholder="dd/mm/yyyy" id="Emp_StartDate" type="text" class="form-control notText max-wide" autocomplete="off" onchange="if(!this.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/)) {dateValidation(this.id);}else{datesuccess(id)}">
                                    </div>
                                </div>
                                <!--- End Start Date--->
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 date" data-provide="datepicker">
                                        <input placeholder="dd/mm/yyyy" id="Emp_EndDate" type="text" class="form-control notText max-wide" autocomplete="off" onchange="if(!this.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/)) { dateValidation(this.id); }else{datesuccess(id)}">
                                    </div>
                                </div>
                                <!--- End yearsexp --->
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 date" data-provide="datepicker">
                                        <input placeholder="dd/mm/yyyy" id="Emp_HireDate" type="text" class="form-control notText max-wide" autocomplete="off" onchange="if(!this.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/)) { dateValidation(this.id); }else{datesuccess(id)}">
                                    </div>
                                </div>
                                <!--- End Hire date --->
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-md-7 col-sm-5 col-xs-12 date" data-provide="datepicker">
                                        <input placeholder="dd/mm/yyyy" id="Emp_ID_Card_Expired_Date" type="text" class="form-control notText max-wide" autocomplete="off" onchange="if(!this.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/)) { dateValidation(this.id); }else{datesuccess(id)}">
                                    </div>
                                </div>
                                <!--- End expired --->
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 date" data-provide="datepicker">
                                        <input placeholder="dd/mm/yyyy" id="Emp_Birth_Date" type="text" class="form-control notText max-wide" autocomplete="off" onchange="if(!this.value.match(/^(\d{1,2})\/(\d{1,2})\/(\d{4})$/)) { dateValidation(this.id); }else{datesuccess(id)}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-header">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sm-12">
                                        <div class="form-group col-md-10 col-lg-10 col-sm-12">
                                            <div class="input-group">
                                              <div class="input-group-btn">
                                                <select class="form-control" style="width: 120px;" id="fillterSearch" >
                                              ...
                                              <input type="text" id="myInputEmp" placeholder="Search for Employee ..." title="Type in a name" class="form-control max-wide" autocomplete="off">
                                            </div>
                    ...
                    <%--modalSiteRef  --%>
                    <div class="modal fade" id="modalDarftEmp" role="dialog" data-backdrop="static" data-keyboard="false">
                                ...
                                <div class="modal-body" style="overflow-y: auto; max-height: 28em; max-width: 100%;">
                                    <div class="col-md-12 col-lg-12 col-sm-12" >
                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-12" >
                                            <input class="form-control max-wide" type="button" onclick="window.location.href = 'MaintainEmployee_Darft.aspx'" value="New Darft Employee" />
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
          ...
          <%--  $.ajax({
            ...
            if (getemp != "") {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee_Darft.aspx/GetListEmployee_Darft") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    ...
                    success: function (response) {
                        ...
                        if (response.d.length > 0) {
                            ...
                            $("#Emp_StartDate").val(response.d[0][13]);
                            $("#Emp_EndDate").val(response.d[0][41]);
                            $("#Emp_HireDate").val(response.d[0][14]);
                            $("#Emp_HR_Shift_ID").val(response.d[0][15]);
                            $("#Emp_Type").val(response.d[0][16]==''?'Salaried':response.d[0][16]);
                            $("#Emp_ID_Card").val(response.d[0][17]);
                            $("#Emp_ID_Card_Expired_Date").val(response.d[0][18]);
                            $("#Emp_Birth_Date").val(response.d[0][19]);
                            $("#Emp_Gender").val(response.d[0][20]);
                            $("#Emp_Nationality").val(response.d[0][21]);
                            $("#Emp_Religion").val(response.d[0][22]);
                            $("#Emp_Marital_Status").val(response.d[0][23]);
                            ...
                            $("#PayFreq").val(response.d[0][46] == '' ? 'M' : response.d[0][46]);
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee.aspx/GetListEmployee_Darft") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    ...
                    success: function (response) {
                        if (response.d.length > 0) {
                            $.each(response.d, function (index, val) {
                                ...
                                //fragment += '<td><a class="clickselectemp" href="javascript:void(0)" >' + emp_extension + '</a></td>';
                                fragment += '</tr>';
                            });
                        } else { }
            ...
            $("#btnsave").on('click', function () {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee_Darft.aspx/SP_HR_Employee_Darft") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        Emp_Num: Emp_Num,
            ...
            $("#btnAddEdu").on("click", function () {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee-Darft.aspx/SP_HR_Employee_Education") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        ID: ID_Tr_Edu,
            ...
            $("#btnAddCer").on('click', function () {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee-Darft.aspx/SP_HR_Employee_Certificate") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        ID: ID_tr_cer,
                    ...
                    success: function (response) {
                        ...
                        //window.location.href = "MaintainEmployee-Darft.aspx?ID=" + getid;
                    }
            ...
            $("#btnAddPer").on('click', function () {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee-Darft.aspx/SP_HR_Employee_Authen") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        Emp_Num: Emp_Num,
                    ...
                    success: function (response) {
                        ...
                        //f += "<tr data-id='" + response.d + "'>"
                        //window.location.href = "MaintainEmployee-Darft.aspx?ID=" + getid;
                        window.location.href = "MaintainEmployee-Darft.aspx?Emp_Num=" + $("#Emp_Num").val();
                    }
                });
            });
            ...
            $("#clickpyramid").on('click', function () {
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee-Darft.aspx/GetListCompanyMain") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ EmpcompMain: getemp, Main: '1' }),
                    success: getlistPyramid
            ...
            $("#newemp").on("click", function () {
                ...
                //window.location.href = "MaintainEmployee-Darft.aspx"
                $('#modalDarftEmp').modal('show');
            });
            ...
            $("#btnmodal").on("click", function () {
                ...
                $("#TBbodyemp").empty();
                var fragment = '';
                var search = sessionStorage.getItem("search") == null ? '' : sessionStorage.getItem("search");
                var fillter = sessionStorage.getItem("fillter") == null ? '' : sessionStorage.getItem("fillter");
                $("#myInputEmp").val(search);
                $("#fillterSearch").val(fillter);
                $.ajax({
                    type: "post",
                    async: false,
                    url: "<%= ResolveUrl("MaintainEmployee-Darft.aspx/GetListEmployee_Darft") %>",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ Emp_Num: "", search: search, type: localStorage.getItem("type"), fillter: fillter }),
                    success: function (response) {
                        if (response.d.length > 0) {
                            $.each(response.d, function (index, val) {
                                var empnum = val[0];
            ...
            $("#fillterSearch").on("change", function () {
                $("#TBbodyemp").empty();
                var fragment = '';
                var values = $("#myInputEmp").val().trim();
                var type = localStorage.getItem("type");
                var fillter = $('#fillterSearch').val();
